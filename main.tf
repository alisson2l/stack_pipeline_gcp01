...
module "bucket-raw" {
  ...
  name       = "stack01-combustiveis-brasil-raw"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-curated" {
  ...
  name       = "stack01-combustiveis-brasil-curated"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-tmp" {
  ...
  name       = "stack01-combustiveis-brasil-pyspark-tmp"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-code" {
  ...
  name       = "stack01-combustiveis-brasil-pyspark-code"
  project_id = var.project_id
  location   = var.region
}